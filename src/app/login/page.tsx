  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#191919]">
      <div className="w-full max-w-md p-8">
        ...
        <p className="text-center text-[#9aa6b2] mb-8">Sign in to your account</p>
        ...
        <p className="mt-8 text-center text-[#9aa6b2]">
          ...
          <Link href="/register" className="text-white hover:text-[#e5e5e5] font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
